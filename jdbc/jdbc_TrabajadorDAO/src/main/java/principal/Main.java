...
//	        actualizar(trabajadorDAO);
	        ...
	        System.out.println("Numero de filas: " + trabajadorDAO.numeroTrabajadores());
	        System.out.println("Numero de filas dpo Ventas: " + trabajadorDAO.numeroTrabajadoresPorDpo("Ventas"));
